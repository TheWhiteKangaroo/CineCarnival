...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2020 at 11:55 AM
...
(20, 'male', 'bond007', 'James', 'Bond', 'koushikur.aiub@gmail.com', 1798452091, 'London, England.', '$2y$10$WmVsvy4ddk.Rz/5nRJAnDu4rwkzhoPnH67C69LgWVF.jiDGggdM6C', 'Regular', 0, '2020-03-21', 3),
...
(22, 'male', '@cena', 'John', 'Cena', 'john.cena@gmail.com', 1798452091, 'USA', '$2y$10$PufKR1LjbopQKCyh8MsyQezHGkBDSgwK2iFizl7jZiAIqBAwmQr.e', 'Regular', 0, '2020-03-30', 3);
...
(12, 'bond007', 'koushikur.aiub@gmail.com', '$2y$10$WmVsvy4ddk.Rz/5nRJAnDu4rwkzhoPnH67C69LgWVF.jiDGggdM6C', '2020-03-30', 3),
(13, '@randy', 'randy.abc@gmail.com', '$2y$10$Z2nGKyDP203syYBi1EoITuL7TLWpzNRwxVd1yAPUk1D1.puGFCscW', NULL, 3),
(14, '@cena', 'john.cena@gmail.com', '$2y$10$PufKR1LjbopQKCyh8MsyQezHGkBDSgwK2iFizl7jZiAIqBAwmQr.e', NULL, 3);
...
--
ALTER TABLE `login`
  MODIFY `l_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
